    ...
    <form action="/admin/providers"  method="post">
        ...
        <section id="main-content" >
            <section class="wrapper">
                ...
                <div style="padding-left: 30em; padding-top: 1em">
                    <label class="text-left" style="font-size: large" >ID Branch: ${providerEdit.idprovider}</label><input type="text" value="${providerEdit.idprovider}" name = "idEdit" hidden><br>
                    <label class="text-left" style="font-size: large">Name: </label>
                    <div ><input  class="form-control" type="text" value="${providerEdit.providername}" name = "providername" style="width: 50%" autofocus></div>
                    <br>
                    <br>
                    <label class="text-left" style="font-size: large">Address: </label>
                    <div> <input class="form-control" type="text" value="${providerEdit.provideraddress}" name = "provideraddress" style="width: 50%" autofocus></div>
                    <br>
                    <br>
                    <label class="text-left" style="font-size: large">Phone: </label>
                    <div> <input class="form-control" type="text" value="${providerEdit.providerphone}" name = "providerphone" style="width: 50%" autofocus></div>

                    <button class="btn btn-primary" type="submit" style="margin-left: 21em; margin-top: 1em">Save</button>
                </div>
