        ...
        <section id="main-content" >
            <section class="wrapper">
                ...
                <div style="padding-left: 30em; padding-top: 1em">
                    <label class="text-left" style="font-size: large" >ID Branch: ${branchEdit.idbranch}</label><input type="text" value="${branchEdit.idbranch}" name = "idEdit" hidden><br>
                    <label class="text-left" style="font-size: large">Name: </label>
                    <div ><input  class="form-control" type="text" value="${branchEdit.branchname}" name = "branchname" style="width: 50%" autofocus></div>
                    <br>
                    <br>
                    <label class="text-left" style="font-size: large">Address: </label>
                    <div> <input class="form-control" type="text" value="${branchEdit.address}" name = "address" style="width: 50%" autofocus></div>
                    <br>
                    <br>
