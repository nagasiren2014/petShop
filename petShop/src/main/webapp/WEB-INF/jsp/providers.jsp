...
<body >
<form action="/admin/providers" method="post">
    <section id="container">
        ...
        <section id="main-content" >
            <section class="wrapper" >
                <h1 class="text-center">Providers List</h1>
                <br>
                <table class="table table-dark  " style="font-size: large; ">
                    ...
                    <c:forEach items="${providersList}" var="item">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary "  type="button"  onclick="window.location = 'providers/providerEdit?idEdit=${item.idprovider}'">
                                    Edit
                                </button>

                            </td>
                            <td>
                                <button class="btn btn-primary "  type="button" data-toggle="modal" data-target="#${item.idprovider}">
                                    Delete
                                </button>
                                <!----modal Del-->
                                <div class="modal fade" id="${item.idprovider}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-danger" onclick="window.location = 'providers?idDel=${item.idprovider}'">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" >
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center " style="background-color: #d9534f">
                                <h3 class="modal-title">Fill your provider's information !</h3>
                            </div>
                            <div class="modal-body">
                                <label class="text-left" style="font-size: large">Name: </label>
                                <div ><input  class="form-control" type="text" placeholder="Name" name = "providername" style="font-size: large" autofocus></div>

                                <br>
                                <br>
                                <label class="text-left" style="font-size: large">Address: </label>
                                <div> <input class="form-control" type="text" placeholder="Address" name = "provideraddress" style="font-size: large" autofocus></div>
                                <br>
                                <br>
                                <label class="text-left" style="font-size: large">Phone: </label>
                                <div> <input class="form-control" type="text" placeholder="Phone" name = "providerphone" style="font-size: large" autofocus></div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel  <i class="fa fa-heart"></i></button>
