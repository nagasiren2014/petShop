            ...
            <section class="wrapper" >
                ...
                <table class="table table-dark  " style="font-size: large; ">
                    ...
                    <c:forEach items="${branchList}" var="item">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary "  type="button"  onclick="window.location = 'branch/branchEdit?idEdit=${item.idbranch}'">
                                    Edit
                                </button>

                            </td>
                            <td>
                                <button class="btn btn-primary "  type="button" data-toggle="modal" data-target="#${item.idbranch}">
                                    Delete
                                </button>
                                <!----modal Del-->
                                <div class="modal fade" id="${item.idbranch}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-danger" onclick="window.location = 'branch?idDel=${item.idbranch}'">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" >
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center " style="background-color: #d9534f">
                                <h3 class="modal-title">Fill your branch's information !</h3>
                            </div>
                            <div class="modal-body">
                                <label class="text-left" style="font-size: large">Name: </label>
                                <div ><input  class="form-control" type="text" placeholder="Name" name = "branchname" style="font-size: large" autofocus></div>

                                <br>
                                <br>
                                <label class="text-left" style="font-size: large">Address: </label>
                                <div> <input class="form-control" type="text" placeholder="Address" name = "address" style="font-size: large" autofocus></div>
                                <br>
                                <br>
                                <label class="text-left" style="font-size: large">City: </label>
                                <div>
                                    <select class="form-control"  style="width: 50%" name="city">
                                        <%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c" %>
                                        <c:forEach items="${cityList}" var="item">
                                            <option selected value = ${item.idcity}>${item.cityname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
