...
<body>
<form action="/admin/pets/deleted" method="post">
            ...
            <div class="row" style="align-items: center;float: bottom">
                ...
                <c:forEach items="${bossList}" var="item">
                    <div class="col-xs-3">
                        <!----------- PRODUCT CARD ----------------->
                        <div class="card" >
                            <a href="pets/edit?idedit=${item.idboss}"  ><img class="card-img-top"   src="../../resources/static/img/bossImg/${item.idboss}.jpg"  alt="${item.idboss}" title="${item.bosscharacter}" style="height: 14em;width: 19.25em" ></a>
                            <div class="card-body" >
