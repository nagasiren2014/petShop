        ...
        <section id="main-content" >
            <section class="wrapper">
                ...
                <div style="padding-left: 30em; padding-top: 1em">
                    <label class="text-left" style="font-size: large" >ID City: ${cityEdit.idcity}</label><input type="text" value="${cityEdit.idcity}" name = "idEdit" hidden><br>
                    <label class="text-left" style="font-size: large">Name: </label>
                    <div ><input  class="form-control" type="text" value="${cityEdit.cityname}" name = "cityname" style="width: 50%" autofocus></div>
