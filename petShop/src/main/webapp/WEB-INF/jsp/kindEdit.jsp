        ...
        <section id="main-content" >
            <section class="wrapper">
                ...
                <div style="padding-left: 30em; padding-top: 1em">
                    ...
                    <h3>ID: ${kindEdit.idkind}<span><input type="text" name="idEdit" value="${kindEdit.idkind}" hidden></span></h3>
                    <h3>Name:  <span><input type="text" name = "nameEdit" value="${kindEdit.name}"></span></h3>
                    <button class="btn btn-primary" type="submit" style="margin-left: 19.75em">Save</button>
                </div>
