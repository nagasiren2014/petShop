        ...
        <section id="main-content" >
            <section class="wrapper">
                ...
                <div style="padding-left: 30em; padding-top: 1em">
                    <label class="text-left" style="font-size: large" >ID Customer: ${customerEdit.idcustomer}</label><input type="text" value="${customerEdit.idcustomer}" name = "idEdit" hidden><br>
                    <label class="text-left" style="font-size: large">Name: </label>
                    <div ><input  class="form-control" type="text" value="${customerEdit.customername}" name = "customername" style="width: 50%" autofocus></div>

                    <label class="text-left" style="font-size: large">Address: </label>
                    <div ><input  class="form-control" type="text" value="${customerEdit.customeraddress}" name = "customeraddress" style="width: 50%" autofocus></div>

                    <label class="text-left" style="font-size: large">Phone: </label>
                    <div ><input  class="form-control" type="text" value="${customerEdit.customerphone}" name = "customerphone" style="width: 50%" autofocus></div>
